...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-md hover:bg-[#ff1a1a] hover:shadow-glow",
        secondary:
          "bg-secondary text-secondary-foreground border border-white/10 hover:bg-[#1a1a1a] hover:border-white/20",
        outline:
          "border border-white/20 bg-transparent text-foreground hover:border-primary/60 hover:bg-primary/10 hover:shadow-glow",
        ghost: "bg-transparent text-foreground hover:bg-white/5 hover:text-white",
        glow: "bg-primary text-primary-foreground shadow-glow hover:bg-[#ff1a1a] hover:shadow-glow-lg neon-glow",
